...
# into a file named "links.html". This is primarily useful if to create a list 
# of selectable Twitch.tv profile links out of an HTML document taken from a 
# Twitch user's 'Following' page.
